...
const items: { textKey: DictKey; icon: "box" | "beaker" | "truck" | "chat" | "shield" | "cert" }[] = [
  { textKey: "feature.us", icon: "box" },
  { textKey: "feature.tested", icon: "beaker" },
  { textKey: "feature.shipping", icon: "truck" },
  { textKey: "feature.support", icon: "chat" },
  { textKey: "feature.physician", icon: "shield" },
  { textKey: "feature.purity", icon: "cert" },
];
